...
class ChargingPackagesEVPage extends StatefulWidget {
  final String chargingType;
  final int selectedPort;

  ChargingPackagesEVPage({super.key, required this.chargingType,required this.selectedPort,});

  @override
  State<ChargingPackagesEVPage> createState() => _ChargingPackagesPageState();
}

class _ChargingPackagesPageState extends State<ChargingPackagesEVPage> {
  final List<Map<String, String>> packages = [
    {"voltage": "1 kWh", "price": "Rs. 500"},
    {"voltage": "2 kWh", "price": "Rs. 1000"},
    {"voltage": "3 kWh", "price": "Rs. 1500"},
    {"voltage": "4 kWh", "price": "Rs. 2000"},
    {"voltage": "5 kWh", "price": "Rs. 3000"},
    {"voltage": "6 kWh", "price": "Rs. 4000"},
  ];
